...
export class RenameTables1718085191588 implements MigrationInterface {
    name = 'RenameTables1718085191588'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "refresh_tokens" DROP CONSTRAINT "FK_265bec4e500714d5269580a0219"`);
